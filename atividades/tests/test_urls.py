...
class TestUrls(SimpleTestCase):
    ...
    def test_apagar_campus(self):
        url = reverse('atividades:apagar_campus',args=[5])
    ...
    def test_apagar_uo(self):
        url = reverse('atividades:apagar_uo',args=[5])
    ...
    def test_apagar_departamento(self):
        url = reverse('atividades:apagar_departamento',args=[5])
